...
## 1. მონაცემთა ჩატვირთვა და მეხსიერების ოპტიმიზაცია
...
| Trial   | Validation AUC | Train AUC | Gap     |
|---------|---------------|-----------|---------|
| Trial 0 | 0.83859       | 0.83960   | 0.00101 |
| Trial 1 | 0.84012       | 0.84105   | 0.00093 |
| Trial 2 | 0.84317       | 0.84409   | 0.00092 |
| Trial 3 | 0.68794       | 0.68800   | 0.00006 |
| Trial 4 | 0.83215       | 0.83085   | 0.00130 |

მიუხედავად იმისა, რომ მოდელი კარგად არის დაბალანსებული, მისი პროგნოზირების სიზუსტე საგრძნობლად ჩამორჩება XGBoost/LGBM მოდელებს. ის ვერ ახერხებს თაღლითობის რთული პატერნების ისეთივე ეფექტურობით ამოცნობას, როგორც სხვა გრადიენტ ბუსტინგის ალგორითმები.
### 5.6 Random Forest
